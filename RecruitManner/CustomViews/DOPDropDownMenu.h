...
@property (nonatomic, assign) NSInteger subItem;
...
// 新增 当有column列 row 行 item项 subItem项 image
- (NSString *)menu:(DOPDropDownMenu *)menu imageNameForsubItemsInRowAtIndexPath:(DOPIndexPath *)indexPath;
// 新增
...
// 当有三级列表subitem时，点击item 是否调用点击代理方法
@property (nonatomic, assign) BOOL isClickHavesubItemValid;
